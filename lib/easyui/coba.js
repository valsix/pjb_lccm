...
win.window("close");
document.location.reload();
//top.frames['mainFrame'].location = linkUrl;
if(fn){
fn();
return false;
}
...
var win=_27f(_285,_286,_287);
return win;
},alertTopLink:function(_285,msg,icon, linkUrl,fn){
var _286="<div>"+msg+"</div>";
switch(icon){
case "error":
_286="<div class=\"messager-icon messager-error\"></div>"+_286;
