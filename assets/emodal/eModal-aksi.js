...
; (function (define) {
    define(['jquery'], function ($, root) {
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                return $('<div class="modal fade" tabindex="-1"><style>.modal-xl{width:calc(100% - 80px) !important;}</style>'
                + '<div class=modal-dialog>'
                + '<div class=modal-content style="height:calc(100vh - 460px);">'
    ...
    define :
    function (args, mName) {
        this.eModalAksi = typeof module != 'undefined' && module.exports ?
