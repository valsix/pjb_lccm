<? 
  ...
  class Operation extends Entity{ 
    ...
    function selectByParamsTahun($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="ORDER BY A.OPR_YEAR ASC")
	{
		...
		$str .= $statement." GROUP BY A.OPR_YEAR, A.SITEID 
		) A
		LEFT JOIN t_preperation_lccm PC ON PC.YEAR_LCCM = A.OPR_YEAR AND PC.SITEID=A.SITEID
		WHERE 1=1
		".$sOrder;
		$this->query = $str;
