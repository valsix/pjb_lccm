<? 
  ...
  class Wo_Pm extends Entity{ 
    ...
    function selectByParamsTahun($paramsArray=array(),$limit=-1,$from=-1, $statement='',  $statement2='',$sOrder="ORDER BY A.PM_YEAR ASC")
	{
		...
		(
			SELECT 
			B.KODE_DISTRIK,B.KODE_BLOK,B.KODE_UNIT,A.PM_YEAR,B.GROUP_PM, A.TOTAL_PM TOTAL_TAHUN
		...
		$str .= $statement." GROUP BY A.PM_YEAR, B.GROUP_PM,B.KODE_DISTRIK,B.KODE_BLOK,B.KODE_UNIT,A.TOTAL_PM
		) A
