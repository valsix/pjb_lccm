...
class PageNumber
{
	...
	{
		$shownav = 7; //berapa banyak navigasi halaman yg ditampilkan (kalo bisa jangan lebih kecil ato sama dgn jumpnav)
		...
		*/
		...
		{ 
			echo "
				<a href='".$this->fileName."&reqPage=1&reqFlag=".$this->anyflag."'>&laquo; First</a>
		...
		{ 
			echo "
				<span class=\"nextprev\"><strong>first</strong></span>
				&nbsp;
			"; 
		}   
		...
		*/
		...
		{ 
			echo "
				&nbsp;<a href='".$this->fileName."&reqPage=".($this->page + 1)."&reqFlag=".$this->anyflag."'>&gt;</a>&nbsp;
				<a href='".$this->fileName."&reqPage=".$this->numPage."&reqFlag=".$this->anyflag."'>Last &raquo;</a>
			";
		} 
		else 
		{ 
