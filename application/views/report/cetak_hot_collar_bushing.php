...
<body>
    ...
    <div class='judul-laporan'>
        ...
        <table style="border-collapse: collapse; font-size:11px; margin-left: auto; margin-right: auto; width: 60%;">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($set->nextRow())
                {
                    ?>
                    <tr>
                        <td style="border: 1px solid black;"><?=$set->getField("BUSHING")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("SKIRT")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("TEGANGAN")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("IMA")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("WATTS")?></td>
                    </tr>
                    <?
                }
                ?>
            ...
            <tr>
                ...
                <td colspan="2">Weather : <?=$reqWeather?></td>
            </tr>
        </table>
