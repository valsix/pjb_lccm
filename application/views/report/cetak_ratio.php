...
<body>
    ...
    <div class='judul-laporan'>
        ...
        <table style="border-collapse: collapse; font-size:11px; margin-left: auto; margin-right: auto; width: 80%;">
            ...
            <thead>
                <tr>
                    <td style="border: 1px solid black;" rowspan="2">Fasa</td>
                    <td style="border: 1px solid black;" rowspan="2">Tap</td>

                    <td style="border: 1px solid black;" colspan="3">Tegangan Nameplate</td>
                    <td style="border: 1px solid black;" colspan="5">Hasil Ukur</td>
                    <td style="border: 1px solid black;" rowspan="2">Deviasi (%)</td>
                </tr>
                <tr>
                    <td style="border: 1px solid black;">HV (kV)</td>
                    <td style="border: 1px solid black;">LV (kV)</td>
                    <td style="border: 1px solid black;">Rasio</td>
            ...
            <tbody>
                ...
                while ($set->nextRow()) 
                {
                    ?>
                    <tr>
                        <td style="border: 1px solid black;"><?=$set->getField("FASA_RATIO")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("TAP_RATIO")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("HV_KV")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("LV_KV")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("RASIO_TEGANGAN")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("HV_V")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("DERAJAT_HV_V")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("LV_V")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("DERAJAT_LV_V")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("RASIO_HASIL")?></td>
                        <td style="border: 1px solid black;"><?=$set->getField("DEVIASI")?></td>
                    </tr>
                    <?
                }
                ?>
