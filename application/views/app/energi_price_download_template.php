...
function downloadfile(){
    ...
    // }
    varurl= "app/loadUrl/app/energi_price_template?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId
        ...
        if (r){
            $.ajax({
                ...
                success: function(data){
                        if(data=="xxx")
                        {
                            $.messager.alert('Info', "Data tidak ditemukan, silahkan pilih Distrik/Blok lain.", 'info');
