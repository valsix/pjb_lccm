...
$objPHPexcel = PHPExcel_IOFactory::load('template/oh_labor.xls');
...
$objWorksheet2->setCellValue("A1","Oh Type");
$objWorksheet2->setCellValue("B1","Description");
...
$field= array();
$field= array("OH_TYPE","DESCRIPTION");

$statement="";


$set = new OhType();
$sOrder=" ORDER BY A.OH_TYPE ASC";
$set->selectByParamsAll(array(), -1,-1, $statement,$sOrder);
...
$objWriter->save('template/export/oh_labor_'.$reqDistrikId.'.xls');

$down = 'template/export/oh_labor_'.$reqDistrikId.'.xls';
