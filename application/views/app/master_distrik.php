...
$arrtabledata= array(
    ...
    , array("label"=>"Wilayah", "field"=> "WILAYAH_NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Distrik", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    
    , array("label"=>"Blok/Unit", "field"=> "BLOK_UNIT_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
//             (
//                SELECT JENIS_UNIT_KERJA_ID FROM DISTRIK_JENIS_UNIT X WHERE X.JENIS_UNIT_KERJA_ID = A.JENIS_UNIT_KERJA_ID
//             )  ";
            ...
            <div class="divfilter filterbaru"  >
                <div class="col-md-12" style="margin-bottom: 20px;" >
                    ...
                    <div class="form-group">
                        ...
                        <label for="inputEmail3" class="col-sm-1 control-label"  style="display: none">Jenis Unit</label>
