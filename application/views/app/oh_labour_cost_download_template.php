...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">Oh Labor Download Template</a> &rsaquo; Form Template</div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Oh Labor Download Template</h3>       
                    </div>
...
function downloadfile(){
    ...
    varurl= "app/loadUrl/app/oh_labour_cost_template?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId
