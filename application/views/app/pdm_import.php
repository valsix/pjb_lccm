...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">WO Pdm</a> &rsaquo; Form Import</div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> WO Pdm</h3>       
                    </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/wo_pdm',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/total_pdm";
                });
        }
    });
}
