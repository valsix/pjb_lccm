...
$objPHPexcel = PHPExcel_IOFactory::load('template/energi_price.xls');
...
$field= array();
$field= array("KODE","NAMA","DISTRIK_KODE","DISTRIK_NAMA");
...
$objWriter->save('template/export/energi_price_'.$reqDistrikId.'.xls');

$down = 'template/export/energi_price_'.$reqDistrikId.'.xls';
