...
<script type="text/javascript">
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/loss_output?reqTahun="+valinfoid;
    ...
    //     varurl= "template/import/loss_output.xls";
    //     document.location.href = varurl;
    // });

    $('#btnTemplate').on('click', function () {
        openAdd("iframe/index/loss_output_download_template");
    });
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/loss_output_json/delete?reqId="+valinfoid+"&reqBlokId="+valinfoblok+"&reqDistrikId="+valinfodistrik,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/loss_output_json/json?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId+"&reqGroupPm="+reqGroupPm;
        datanewtable.DataTable().ajax.url(jsonurl).load();
    });
