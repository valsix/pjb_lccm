...
<script type="text/javascript">
    ...
    var indexfieldcost= arrdata.length - 2;
    var indexfieldtahun= arrdata.length - 3;
    var valinfoid= valinfotahun= valinfocost= valinfoend='';
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/prk_add?reqId="+valinfoid+"&reqCost="+valinfocost+"&reqTahun="+valinfotahun;
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/prk_json/delete?reqId="+valinfoid+"&reqCost="+valinfocost+"&reqTahun="+valinfotahun,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        location.reload();
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/prk_json/json?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/prk_json/jsondetail?reqTahun=<?=$reqTahun?>&reqGroupPm=<?=$reqGroupPm?>";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfocost= arrdata[indexfieldcost]["field"];
                fieldinfotahun= arrdata[indexfieldtahun]["field"];
                valinfoid= dataselected[fieldinfoid];
                valinfocost=  dataselected[fieldinfocost];
                valinfocost=valinfocost.replace(/[ ,]/g, "");
                valinfocost=valinfocost.substring(0,valinfocost.length-2);
                // console.log(valinfocost);return false;
