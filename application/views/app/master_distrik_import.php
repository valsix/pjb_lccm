                         ...
                         <div class="card-body">
                            <div class="warning box" style="text-align: justify;font-size: 18px">
                                <ol>
                                    ...
                                    <li>Kolom <b>Wilayah Id/Direktorat Id/Perusahaan Id</b> diisi dengan format <b>Angka/Integer</b> sesuai master data masing-masing.
                                    </li>
                                </ol>
                            </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/distrik_template',
        onSubmit:function(){
