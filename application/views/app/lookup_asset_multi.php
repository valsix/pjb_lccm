        ...
        <div class="row row-treegrid">
            ...
            <div class="col-md-9 col-treegrid">
                <div class="area-konten-atas">
                    <div class="judul-halaman">Asset </div>
                ...
                <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                    <table id="treeSatker" class="easyui-treegrid" style="min-width:100px !important;height:300px"
                            data-options="
                                url: 'json-app/asset_lccm_json/tree_multi?reqDistrikId=<?=$reqDistrikId?>&reqBlokId=<?=$reqBlokId?>&reqUnitMesinId=<?=$reqUnitMesinId?>',
                                pagination: false, 
                                method: 'post',
                                idField: 'ID',
                                treeField: 'NAMA',
                        ...
                        <thead>
                            <tr>
                                <th data-options="field:'ID',width:30" formatter="formatcheckbox">Asset Num </th>
                                <th data-options="field:'NAMA',width:150" >Nama Asset</th>
...
{
    idata=0;
    infodetilparaf= '<label>Asset Terpilih:</label><button class="btn btn-primary btn-sm" type="button" onClick="setsatuankerjapilih()"><i class="fa fa-user-circle"></i> Ok</button>';
    ...
    if(idata == 0)
    {
        infodetilparaf= '<label>Asset Terpilih: Pilih salah satu data</label><button class="btn btn-primary btn-sm" type="button" onClick="setsatuankerjapilih()"><i class="fa fa-user-circle"></i> Ok</button>';
    }
...
$(document).ready( function () {     
    ...
    $('input[name=reqPencarian]').keyup(function(e) {
        ...
        if(e.keyCode == 13) {
            var urlApp = 'json-app/asset_lccm_json/tree_multi/?reqId=<?=$reqId?>&reqSearch='+value;
            $('#treeSatker').treegrid(
            {
                url: urlApp,
