...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">Oh Labor Import</a> &rsaquo; Form Import</div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Oh Labor Import</h3>       
                    </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/oh_labor',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/oh_labour_cost";
                });
        }
    });
}
