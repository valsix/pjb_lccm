...
$arrtabledata= array(
    ...
    , array("label"=>"Description Asset", "field"=> "EQUIPMENT_DESC", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"Downtime", "field"=> "VALIDATION_DOWNTIME", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"DOWN 0 & NOT OH", "field"=> "STATUS_NOT_OH_NOT_DOWNTIME", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"On Hand Repair", "field"=> "ON_HAND_REPAIR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Labour", "field"=> "JUMLAH_LABOR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
    ...
    var indexfieldwo= arrdata.length - 2;
    // var indexfielddistrik= arrdata.length - 3;
    var valinfoid= valinfowo= valinfoblok= valinfodistrik='';
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/work_order_valid_add?reqTahun=<?=$reqTahun?>&reqAssetNum="+valinfoid+"&reqWoNum="+valinfowo;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/work_order_valid_add?reqTahun=<?=$reqTahun?>&reqAssetNum="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/work_order_json/jsonvalidasi?reqApprovalStatus=1&reqTahun=<?=$reqTahun?>&reqDistrikId=<?=$reqDistrikId?>&reqBlokId=<?=$reqBlokId?>&reqUnitMesinId=<?=$reqUnitMesinId?>&reqAssetNum=<?=$reqAssetNum?>";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfowo= arrdata[indexfieldwo]["field"];
                valinfoid= dataselected[fieldinfoid];
                valinfowo= dataselected[fieldinfowo];
