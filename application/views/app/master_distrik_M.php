...
$arrtabledata= array(
    ...
    , array("label"=>"District Code", "field"=> "DISTRICT_CODE", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"District Name", "field"=> "DISTRICT_NAME", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    
    , array("label"=>"fieldid", "field"=> "DISTRICT_CODE", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<div class="col-md-12">
    <div class="judul-halaman"> Data Distrik</div>
