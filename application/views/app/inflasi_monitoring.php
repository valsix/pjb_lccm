...
$arrtabledata= array(
    ...
    , array("label"=>"Tahun Awal", "field"=> "TAHUN_AWAL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Tahun Akhir", "field"=> "TAHUN_AKHIR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Inflasi", "field"=> "INFLASI", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
   

    , array("label"=>"fieldid", "field"=> "M_INFLASI_CALCULATE_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/inflasi_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/inflasi_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/inflasi_import");
    });
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/inflasi_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/inflasi_json/json?reqPencarian="+reqPencarian+"&reqKode="+reqKode+"&reqStatus="+reqStatus;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/inflasi_json/json";
