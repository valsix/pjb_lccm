    ...
    <div class="konten-area">
    	<div id="bluemenu" class="aksi-area">
           <?
            ...
            <!-- <span><a id="btnUpload"><i class="fa fa-upload" aria-hidden="true"></i> Upload</a></span> -->
            <?
            }
            if($reqRead ==1)
            {
            ...
            <span><a id="btnApi"><i class="fa fa-code"></i> Eam</a></span>
            ...
            <div class="divfilter filterbaru"  >
                <div class="col-md-12" style="margin-bottom: 20px;" >
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <label  style="display: none" for="inputEmail3" class="col-sm-1 control-label">Blok Unit</label>
                        <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    //     varurl= "template/import/wo_pm.xls";
    //     document.location.href = varurl;
    // });

    $('#btnImport').on('click', function () {
        openAdd("iframe/index/wo_pm_import");
    });

    $('#btnTemplate').on('click', function () {
        openAdd("iframe/index/wo_pm_download_template");
    });
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/wo_pm_json/delete?reqId="+valinfoid+"&reqBlokId="+valinfoblok+"&reqDistrikId="+valinfodistrik,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/wo_pm_json/json?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId+"&reqGroupPm="+reqGroupPm;
        datanewtable.DataTable().ajax.url(jsonurl).load();
	});
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                $(".labeltahun").text(dataselected['PM_YEAR']);
            }
        } );
