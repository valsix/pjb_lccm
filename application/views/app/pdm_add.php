...
else
{
    ...
    $statement = " AND A.ASSETNUM = '".$reqId."' AND A.PDM_YEAR = '".$reqTahun."' AND A.PDMNUM = '".$reqPdmNum."'  ";
    ...
    $reqTahun= $set->getField("PDM_YEAR");
    $reqDuration= $set->getField("DURATION_HOURS");
    $reqPdmCount= $set->getField("PDM_IN_YEAR");
    $reqPdmNum= $set->getField("PDMNUM");
...
<div class="col-md-12">
  ...
  <div class="konten-area">
    <div class="konten-inner">
        ...
        <div>
            ...
            <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                <div class="form-group" id="parentname"> 
                    <label class="control-label col-md-2">PDM No</label>
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                <input autocomplete="off"  <?=$readonly?> required   class="easyui-validatebox textbox form-control" type="text" name="reqPdmNum"  id="reqPdmNum" value="<?=$reqPdmNum?>" <?=$disabled?> style="width:100%" />
                            </div>
                       </div>
                   </div>
                </div>
                ...
                <div class="form-group" id="parentname"> 
                    <label class="control-label col-md-2">Description PDM</label>
                    <div class='col-md-8'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                <textarea class="easyui-validatebox textbox form-control" required name="reqDescription"  id="reqDescription"><?=$reqDescription?></textarea>
                            </div>
                       </div>
                   </div>
                </div>
                ...
                <div class="form-group" id="parentname"> 
                    <label class="control-label col-md-2">PDM Count (Year)</label>
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                <input autocomplete="off"  <?=$readonly?> required   class="easyui-validatebox textbox form-control" type="text" name="reqPdmCount"  id="reqPdmCount" value="<?=$reqPdmCount?>" <?=$disabled?> style="width:100%" />
                            </div>
                       </div>
                   </div>
                </div>
                ...
                <div class="form-group" id="parentname"> 
                    <label class="control-label col-md-2">PDM Year</label>
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='col-md-11'>
       ...
       <input type="hidden" name="reqPdmNumOld" value="<?=$reqPdmNum?>" />
...
<script>
    ...
    $("#reqDuration").keydown(function (event) {
    ...
    $('#reqTahun,#reqPdmCount,#reqNumberPersonal').on('input blur paste', function(){
