...
<script type="text/javascript">
    ...
    var elselect='<select id="reqStatus"  sclass="statusgen" style="color: #000000;" ><option value="">Semua</option><option value="TRUE">Valid</option><option value="FALSE">Tidak Valid</option></select>';

    $('.table').on('init.dt', function() {
        $('.selectstatus ').html(elselect);
        $('#reqStatus').on('change', function() {
            reqStatus=$('#reqStatus').val();
            jsonurl= "json-app/prk_json/json?reqStatus="+reqStatus;
