...
$arrtabledata= array(
    ...
    , array("label"=>"PDM No", "field"=> "PDMNUM", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Description PDM", "field"=> "PDM_DESC", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"PDM Count (Yearly)", "field"=> "PDM_IN_YEAR", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "PDMNUM", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<div class="col-md-12">
    <div class="judul-halaman"> Data WO PDM</div>
...
<script type="text/javascript">
    ...
    var indexfieldpdmnum= arrdata.length - 3;
    var valinfoid= valinfotahun= valinfopdmnum= valinfojpnum= '';
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/pdm_add?reqId="+valinfoid+"&reqTahun="+valinfotahun+"&reqPdmNum="+valinfopdmnum;
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/pdm_json/delete?reqId="+valinfoid+"&reqTahun="+valinfotahun+"&reqPdmNum="+valinfopdmnum,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        location.reload();
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/pdm_json/json?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/pdm_json/jsondetail?reqTahun=<?=$reqTahun?>&reqGroupPm=<?=$reqGroupPm?>";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfopdmnum= arrdata[indexfieldpdmnum]["field"];
                valinfoid= dataselected[fieldinfoid];
                valinfotahun= dataselected[fieldinfotahun];
                valinfopdmnum= dataselected[fieldinfopdmnum];
