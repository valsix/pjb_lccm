...
<div class="col-md-12">
    <div class="judul-halaman"> Data Asset</div>
...
<script type="text/javascript">
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/lookup_json/jsonequipment?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/lookup_json/jsonequipment";
    ...
    $(document).ready(function() {
        ...
        $('#'+infotableid+' tbody').on( 'dblclick', 'tr', function () {
            ...
            parent.setEquipment(dataselected);
            top.closePopup();
        });
