...
$objPHPexcel = PHPExcel_IOFactory::load('template/loss_output.xls');
...
$objWriter->save('template/export/loss_output_'.$reqDistrikId.'.xls');

$down = 'template/export/loss_output_'.$reqDistrikId.'.xls';
