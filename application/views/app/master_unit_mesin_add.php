            ...
            <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                <div class="form-group">  
                    ...
                    <div class='col-md-8'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                 <input autocomplete="off" <?=$readkode?> class="easyui-validatebox textbox form-control" placeholder="Kode Harus unik dan tidak boleh ada spasi dan maksimal 10 character" maxlength="10" type="text" name="reqKode"  id="reqKode" value="<?=$reqKode?>"  <?=$disabled?> data-options="required:true" style="width:100%" />
                            </div>
                        </div>
                    </div>
                </div>
