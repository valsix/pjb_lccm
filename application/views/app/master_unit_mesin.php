...
<div class="col-md-12">
    <div class="judul-halaman"> Data Unit Mesin <?=$reqNama?> <?=$reqBlokNama?></div>
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "iframe/index/master_unit_mesin_add?reqId="+valinfoid+"&reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>";
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "iframe/index/master_unit_mesin_add?reqId="+valinfoid+"&reqLihat=1"+"&reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>";;
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/unit_mesin_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/unit_mesin_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        location.reload();
    ...
    $('#btnImport').on('click', function () {  
        ...
        varurl= "iframe/index/master_unit_mesin_import?reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>";
        document.location.href = varurl;
    });

    // $('#btnImport').on('click', function () {
    //     openAdd("app/index/master_unit_mesin_import");
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/unit_mesin_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/unit_mesin_json/json?reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>";
