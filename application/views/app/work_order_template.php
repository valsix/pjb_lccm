...
$objPHPexcel = PHPExcel_IOFactory::load('template/workorder.xls');
...
$objWriter->save('template/export/work_order_'.$reqDistrikId.'.xls');

$down = 'template/export/work_order_'.$reqDistrikId.'.xls';
