                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    <input autocomplete="off" <?=$reqKodeReadonly?> placeholder="Kode Harus unik dan tidak boleh ada spasi"  class="easyui-validatebox textbox form-control" required type="text" name="reqKode"  id="reqKode" value="<?=$reqKode?>"  style="width:100%"  />
                                </div>
                            </div>
                        </div>
                    </div>
