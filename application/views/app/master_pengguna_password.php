...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/master_pengguna">Data Master Password</a> &rsaquo; Reset Password Master</div>
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        url:'json-app/pengguna_json/reset_master_password',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alertLink('Info', infoSimpan, 'info', "app/index/master_pengguna");
        }
    });
}
