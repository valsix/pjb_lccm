...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "OH_TYPE", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
$arrohtype= [];
$statement="  ";
$set->selectByParamsOhType(array(), -1,-1,$statement);
// echo $set->query;exit;
while($set->nextRow())
{
    $arrdata= array();
...
<div class="col-md-12">
    <div class="judul-halaman"> Data Master Oh Labor</div>
            ...
            <div class="divfilter filterbaru"  >
                <div class="col-md-12" style="margin-bottom: 20px;" >
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-1 control-label">Oh Type</label>
                        <div class="col-sm-4">
                            <select class="form-control jscaribasicmultiple"  <?=$readonly?>  id="reqOhType" <?=$disabled?> name="reqOhType"  style="width:100%;" >
...
<script type="text/javascript">
    ...
    var indexfieldassetnum= arrdata.length - 2;
    var valinfoid= valinfooh=  valinfoassetnum= '';
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/oh_labour_cost_add?reqId="+valinfoid+"&reqOh="+valinfooh+"&reqAssetNum="+valinfoassetnum;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/oh_labour_cost_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/oh_labour_cost_import");
    });

    $('#btnTemplate').on('click', function () {
        openAdd("iframe/index/oh_labour_cost_download_template");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/oh_labour_cost_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnCari').on('click', function () {
        ...
        reqKode='';
        reqOh=$('#reqOh').val();
        var reqOhType=$('#reqOhType').val();

        jsonurl= "json-app/oh_labour_cost_json/json?reqOhType="+reqOhType;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/oh_labour_cost_json/json";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfoassetnum= arrdata[indexfieldassetnum]["field"];
                valinfoid= dataselected[fieldinfoid];
                valinfoassetnum= dataselected[fieldinfoassetnum];
            }
        } );
