...
$objPHPexcel = PHPExcel_IOFactory::load('template/wo_pm.xls');
...
$objWriter->save('template/export/wo_pm_'.$reqDistrikId.'.xls');

$down = 'template/export/wo_pm_'.$reqDistrikId.'.xls';
