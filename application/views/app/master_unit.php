...
$arrtabledata= array(
    ...
    , array("label"=>"Unit Code", "field"=> "UNIT_CODE", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Ell Code", "field"=> "ELL_CODE", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Max Code", "field"=> "MAX_CODE", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Unit Name", "field"=> "UNIT_NAME", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    
    , array("label"=>"fieldid", "field"=> "UNIT_CODE", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<script type="text/javascript">
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/unit_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
