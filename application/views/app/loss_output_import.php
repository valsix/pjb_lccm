...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>"><?=$pgtitle?></a> &rsaquo; Form Import</div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/loss_output',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/total_output";
                });
        }
    });
}
