...
$objPHPexcel = PHPExcel_IOFactory::load('template/operation.xls');
...
$objWriter->save('template/export/operation_'.$reqDistrikId.'.xls');

$down = 'template/export/operation_'.$reqDistrikId.'.xls';
