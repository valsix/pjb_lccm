...
$this->load->model("base-app/M_Unit");
...
else
{
	...
	$statement = " AND A.UNIT_CODE = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqUnitCode= $set->getField("UNIT_CODE");
    $reqEllCode= $set->getField("ELL_CODE");
    $reqMaxCode= $set->getField("MAX_CODE");
    $reqUnitName= $set->getField("UNIT_NAME");
...
<div class="col-md-12" >
    ...
    <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">Data Unit</a> &rsaquo; Kelola Unit</div>
        ...
        <div class="konten-inner" >
            ...
            <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                <div class="form-group">  
                    <label class="control-label col-md-2">Unit Code</label>
                    <div class='col-md-8'>
                        <div class='form-group'>
                            <div class='col-md-4'>
                                 <input autocomplete="off" placeholder="" class="easyui-validatebox textbox form-control " type="text" name="reqUnitCode"  id="reqUnitCode" value="<?=$reqUnitCode?>"  <?=$disabled?> data-options="required:true" style="width:100%" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">  
                    ...
                    <div class='col-md-8'>
                        <div class='form-group'>
                            <div class='col-md-12'>
                                 <input autocomplete="off" class="easyui-validatebox textbox form-control " type="text" name="reqUnitName"  id="reqUnitName" value="<?=$reqUnitName?>" <?=$disabled?> data-options="required:true" style="width:100%" />
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).on('keydown', '#reqUnitCode,#reqEllCode,#reqMaxCode', function(e) {
