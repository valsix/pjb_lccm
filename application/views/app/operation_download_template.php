    ...
    <div class="konten-area">
        <div class="konten-inner">
                    ...
                    <div class="form-group">  
                         <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control jscaribasicmultiple"   <?=$readonlyblok?> <?=$readonly?> id="reqBlokId"   name="reqBlokId"  style="width:100%;"  >
            ...
            <div style="text-align:center;padding:5px">
                <br>
                <a href="javascript:void(0)" class="btn btn-primary" onclick="downloadfile()">Download Template</a>
                <a href="javascript:void(0)" id="btnupload" class="btn btn-success" >Upload File</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#btnupload").on("click", function () {
        varurl= "iframe/index/operation_import";
...
function downloadfile(){
    ...
    varurl= "app/loadUrl/app/operation_template?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId
