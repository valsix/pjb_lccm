...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">Operation Equipment Import </a> &rsaquo; Form Import</div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Operation Equipment Import</h3>       
                    </div>
...
function kembali(){
    varurl= "iframe/index/operation_download_template?reqId=";
    document.location.href = varurl;
}   

function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/operation',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/operation";
                });
        }
    });
}
