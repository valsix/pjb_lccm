    ...
    <div class="konten-area">
        <div id="bluemenu" class="aksi-area">
           <?
            ...
            {
            ?>
            <span><a id="btnAddPlant"><i class="fa fa-plus-square fa-lg" aria-hidden="true"></i> Operation Plant </a></span>
            <span><a id="btnTemplate"><i class="fa fa-plus-square fa-lg" aria-hidden="true"></i> Operation Equipment </a></span>
            <?
            }
            if($reqRead ==1)
            {
            ...
            <span><a id="btnProses"><i class="fa fa-database  fa-lg" aria-hidden="true"></i> Proses </a></span>
            <?
            }
            ?>
...
<script type="text/javascript">
    ...
    $('.table').on('init.dt', function() {
        ...
        $('#reqStatus').on('change', function() {
            ...
            jsonurl= "json-app/operation_json/json?reqStatus="+reqStatus;
    ...
    $("#btnAddPlant").on("click", function () {
        ...
        varurl= "app/index/operation_plant_add?reqTahun="+valinfoid;
    ...
    $("#btnEdit").on("click", function () {
        ...
        varurl= "app/index/operation_detil?reqTahun="+valinfoid;
        document.location.href = varurl;
    });
    ...
    $("#btnProses").on("click", function () {
        ...
        var pesan='Apakah anda yakin untuk proses data terpilih?';
         varurl="json-app/operation_json/proses?reqTahun="+valinfoid;
            ...
            if (r){
                ...
                success: function(data){
                    ...
                    infoSimpan= data[1];
                        ...
                        {
                           $.messager.alertLink('Info', infoSimpan, 'info', "app/index/operation");
    ...
    $('#btnDelete').on('click', function () {
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/operation_json/delete?reqId="+valinfoid+"&reqBlokId="+valinfoblok+"&reqDistrikId="+valinfodistrik,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/operation_json/json?reqDistrikId="+reqDistrikId+"&reqBlokId="+reqBlokId+"&reqUnitMesinId="+reqUnitMesinId+"&reqGroupPm="+reqGroupPm;
        datanewtable.DataTable().ajax.url(jsonurl).load();
    });
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/operation_json/json";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                $(".labeltahun").text(dataselected['OPR_YEAR']);
            }
        } );
        ...
        $("#btnValid, #btnNotValid").on("click", function () {
            ...
            $.messager.confirm('Konfirmasi',vinfo,function(r){
                if (r){
                    $.getJSON("json-app/general_json/preperation_lccm_new?m=OPERATION&t="+vtahun+"&vdistrik="+vdistrik+"&vblok="+vblok+"&vunit="+vunit+"&value="+value,
                        function(data){
                            $.messager.alert('Info', data.PESAN, 'info');
                            valinfoid= "";
                            setCariInfo();
